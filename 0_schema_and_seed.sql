...
INSERT IGNORE INTO dim_exchange(exchange_id,exchange_code)
VALUES (1,'HOSE');

INSERT IGNORE INTO dim_data_source(source_id,source_name,source_type)
VALUES (1,'BCTC_Source','financial_statement');


INSERT INTO dim_firm(ticker,company_name,exchange_id)
VALUES ('DUMMY_TICKER','Cong ty Gia dinh Test',1);
